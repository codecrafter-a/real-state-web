                  ...
                  <td colSpan={7} className="px-4 py-2">
                    ...
                    <div className="mt-3 d-flex justify-content-start align-item-center">
                      <div className="d-flex flex-column align-item-center">
                        ...
                        <ul className="list-unstyled mb-0 text-start">
                          ...
                          <li>
                            <Link>{t("recent_agreements_value_2")}</Link>
                          </li>
                        </ul>
                      </div>
                    </div>
                    <div className="d-flex justify-content-between align-items-center my-3">
                      ...
                      <div className="d-flex align-items-center">
                        <span className="cursor-pointer" onClick={() => navigate(`/${lang}/customers/add-customers`)}><img src={edit} alt={"editbtn"} className="px-1" /></span>
                        <img
                          src={deleteIcon}
                          alt={"deletebtn"}
                          className="px-1"
