    ...
    <div className="p-md-4 p-2 custom-col rounded-3">
        ...
        <div className="px-md-3">
          <div className="d-flex flex-wrap gap-3 align-items-start mobile-form my-md-0 my-5 position-relative">
            <div className="d-flex flex-column flex-grow-1 pt-sm-0 pt-5">
              <div className="d-md-flex flex-wrap justify-content-between w-100 gap-4 align-items-center">
                <div className="d-md-flex gap-5">
                  <div className="d-md-flex align-items-center gap-5">
                    <div
                      className="cursor-pointer d-inline-block company-logo"
                    ...
                    <div className="d-md-block d-flex mb-md-0 mb-3 justify-content-between">
                      <div className="d-flex flex-column my-auto text-nowrap">
                        <span className="fs-5 d-flex fw-semibold text-teal">
                          {t("personalArea.name")}
                        </span>
                        <span className="fs-5 fw-semibold text-teal">
                          {t("personalArea.role")}
                        </span>
                      </div>
                      <div className="d-md-none">
                        <button className="hdr_btn border border-transparent">
                  ...
                  <div className="d-flex flex-wrap gap-4 align-items-center">
                    <div className="d-flex flex-md-wrap gap-md-4 gap-3 align-items-center text-end">
                      <div className="d-flex flex-column my-auto text-nowrap">
                        <span className="home-card-title d-flex fw-semibold text-secondary text_start">
                          {t("personalArea.area_type")}
                        </span>
                        <span className="home-card-subtitle text-dark">
                          STARTER
                        </span>
                      </div>
                      <div className="d-flex flex-column my-auto">
                        <span className="home-card-title d-flex fw-semibold text-secondary text_start">
                          {t("personalArea.endDate")}
                        </span>
                        <span className="home-card-subtitle text-dark">
                          17.07.2023
                        </span>
                      ...
                      <div className="d-flex flex-column my-auto">
                        <span className="home-card-title d-flex fw-semibold text-secondary text_start">
                          {t("personalArea.agreementsSentThisMonth")}
                        </span>
              ...
              <button
                className="d-flex mt-md-5 mt-4 link-text fw-semibold text-decoration-underline border-0 bg-transparent"
                onClick={() =>
                  navigate(`/${lang}/personal-area/signature-invoice`)
                }
              >
            ...
            <div className="row">
              ...
              <div className="col-md-4 mb-md-0 mb-3">
                ...
                <span
                  ...
                  onClick={() =>
                    navigate(`/${lang}/personal-area/change-email`)
                  }
                >
              ...
              <div className="col-md-4 mb-md-0 mb-3">
                ...
                <span
                  className="link-text d-block mt-1 fw-semibold text-decoration-underline cursor-pointer"
                  onClick={() =>
                    navigate(`/${lang}/personal-area/change-password`)
                  }
                >
      ...
      >
        ...
        <Modal.Body className="text-center p-4">
          <h4 className="text-embed-500 fw-bold">
            {t("personalArea.modalTitle")}
          </h4>
          <div className="d-flex justify-content-center mt-4 mb-5">
            <div className="text-center d-flex align-items-center flex-column w-full">
              ...
              <p className="mt-2 text-black fw-semibold fs-5">
                {t("personalArea.cameraOption")}
              </p>
            </div>
            ...
            <div className="text-center d-flex align-items-center justify-content-center flex-column w-full">
              <div className="rounded-circle p-4 d-flex align-items-center justify-content-center gallery-option-circle">
                <MdOutlineAddPhotoAlternate
                  size={48}
                  className="text-embed-500"
                />
              </div>
              <p className="mt-2 text-black fw-semibold fs-5 w-75">
                {t("personalArea.galleryOption")}
              </p>
            </div>
          </div>
        </Modal.Body>
