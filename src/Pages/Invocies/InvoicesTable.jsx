        ...
        <thead>
         ...
         <tbody className="border">
          {data.length > 0 ? (
              ...
              <tr key={row.id}>
                ...
                <td className="d-table-cell align-middle">
                  <div className="d-flex align-items-center gap-4 p-2">
                    <button onClick={handleClick} className="flex gap-1 items-center border-0 bg-transparent">
                      <IoEyeOutline /> <span className="fs-15 lh-1">{t("view")}</span>
                    </button>
            ...
            <tr>
              <td colSpan="6" className="text-center py-4 fs-16 fw-semibold">
                {t("no_invoices_found")}
              </td>
            </tr>
          )}
