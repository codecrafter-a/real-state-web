        ...
        <React.Fragment>
            ...
            >
                ...
                <div className="h-[646px] overflow-y-scroll custom-scrollbar">
                    <div className="mr-7">
                        <Nav variant="tabs" className="d-flex justify-content-end px-3 pt-2 px-md-4 border-bottom">
                            <Nav.Item>
                                <Nav.Link
                                ...
                                <div>
                                    <div className="w-full d-flex justify-end">
                                        <div className="position-relative d-flex justify-between">
                                            ...
                                            <input
                                                ...
                                                placeholder="חפשו הסכם לפי כתובת / שם לקוח"
                                    ...
                                    <div className="row justify-center align-items-center mt-4">
                                        <div className="col-auto mt-3">
                                            <button className="btn btn-outline-success">הצגה</button>
                                        </div>
                                        <div className="col-auto d-flex align-items-center mt-3">
                                            <label className="form-check-label me-2">הפקת חשבונית</label>
                                            <div className="form-check form-switch">
                                                <input className="form-check-input" type="checkbox" id="invoiceToggle" />
                                            </div>
                                        </div>
                                        <div className="col fw-semibold">
                                            <label className="d-flex justify-content-end w-100">סטטוס הסכם</label>
                                    ...
                                    <div className="d-flex mt-4 justify-end">
                                        <span className="bg-emerald-500 flex gap-4 py-2.5 px-3 rounded-[18px] h-10 align-items-center" style={{ backgroundColor: "#E9FAF4" }}>
