...
const Sidebar = ({isToggle}) => {
  ...
  return (
    <>
      <section className={`haeder_right_block w-344 d-flex flex-column justify-content-between ${!isToggle ? 'd-none d-lg-flex ' : ''}  ${isAuthenticated ? "active" : "disabled"}`}>
        <div className="haeder_right pt-md-4 overflow-auto custom-scrollbar">
